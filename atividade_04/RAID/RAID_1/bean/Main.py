...
from atividade_04.RAID.RAID_1.bean.Block import Block
from atividade_04.RAID.RAID_1.bean.GLOBAL import GLOBAL
from atividade_04.RAID.RAID_1.bean.Shell import *
